                            ...
                            @foreach($reservations as $key=>$reservation)
                                <tr>
                                    <td style="text-align: center;">
                                        <a href="{{route('vendor.reservation.view-reservation', $reservation->id)}}" alt="view reservation">
                                            <label class="input-label"><strong>{{ $reservation->start_time }} ~ {{ $reservation->end_time }}</strong>
                                    ...
                                    <td style="text-align: center;">
                                        <a href="{{route('vendor.reservation.view-reservation', $reservation->id)}}">{{$reservation->order_id}}</a>
                                    </td>
                                    <td style="text-align: center;">
                                        <a href="{{route('vendor.reservation.view-reservation', $reservation->id)}}" alt="View reservation">
                                    ...
                                    <td style="text-align: center;">
                                        <a href="{{route('vendor.reservation.view-reservation', $reservation->id)}}">
                                    ...
                                    <td style="text-align: center;">
                                        <a class="btn btn-sm btn-danger"
                                            href="{{route('vendor.reservation.view-reservation', $reservation->id)}}" title="{{__('messages.view')}}">
