        ...
        <div class="page-header">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="{{route('vendor.reserveplace.ongoing')}}">Place Orders</a></li>
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-4">
                        <small class="nav-subtitle border-bottom text-secondary">Place Name</small>
                        <div class="row">
