    ...
    <div class="page-header">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Processing Place Orders</li>
            </ol>
        </nav>
    </div>
    <div class="page-header">
        ...
        <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <h5>Processing Place Orders List
                        ...
                        <table id="columnSearchDatatable"
                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th style="width: 25%; text-align: center;">{{__('messages.table')}}</th>
                                    <th style="width: 10%; text-align: center;">Price</th>
                                    <th style="width: 15%; text-align: center;">Payment Status</th>
                            ...
                            @foreach($reservations as $key=>$reservation)
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a href="{{route('vendor.reserveplace.view-reservation', $reservation->id)}}">{{$reservation->order_id}}</a>
                                    </td>
                                    <td style="text-align: center;">
