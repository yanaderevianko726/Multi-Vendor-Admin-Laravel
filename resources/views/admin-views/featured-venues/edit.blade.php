...
@section('title','Update Featured Venue')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('admin.featuredVenues.add-new')}}">Featured Restaurants</a></li>
                </ol>
            </nav>
        </div>
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-edit"></i>Update Featured Venue Inofmation</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('admin.featuredVenues.update', [$featuredVenue['id']])}}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
