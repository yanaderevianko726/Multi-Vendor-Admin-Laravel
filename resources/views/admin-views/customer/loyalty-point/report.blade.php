                ...
                <div class="row">
                    <div class="col-lg-12 pt-3">
                        <form action="{{route('admin.customer.loyalty-point.report')}}" method="get">
                            ...
                            <div class="row">
                                <button type="submit" class="btn btn-primary col-lg-2 col-md-3 col-sm-4 col-6 mx-3 text-capitalize font-weight-bold align-self-end"><i class="tio-filter-list mr-1"></i>{{__('messages.filter')}}</button>
                            </div>
                        </form>
                    </div>
                </div>                
